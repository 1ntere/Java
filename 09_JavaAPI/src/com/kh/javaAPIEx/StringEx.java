...
public class StringEx {
	public static void main(String[] args) {
		//String str = new String();
			//원래는 String을 import해서 공간을 새로 창조해주고 str을 사용해야하지만
			//String의 경우 그냥 String str = "Hello World"; 형태로 사용해도 된다.
		String str1 = "Hello";
		String str2 = "World";
		...
		System.out.println(서브스트링);//World!
			//6부터 끝까지만 보여준다는 의미
		String 서브스트링1 = 문자열.substring(6,8);
			//6부터 7까지만 보여준다는 의미
		System.out.println(서브스트링1);//Wo
		
		//2. toUpperCase()
		String 대문자 = 문자열.toUpperCase();
		System.out.println("대문자 맞나요 ? : "+대문자);//HELLO WORLD!
		
		//3. toLowerCase()
		String 소문자 = 문자열.toLowerCase();
		System.out.println("소문자 맞나요 ? : "+소문자);//hello world!
		
		//4. trim()
		String 공백가득 = "     Hello   World!     ";
		String 공백제거 = 공백가득.trim();
		System.out.println("공백제거 됐나요 ? : "+공백제거);//Hello   World!
			//중간에 있는 공백은 제거가 되지 않고, 양쪽의 공백만 제거됨
		...
		//String 하이월드 = "H   i   ,       W   o   r   l   d   !";
		//빈칸도 글자임
		String 하이월드 = "Hi, World!";
		char ch = 하이월드.charAt(4);
