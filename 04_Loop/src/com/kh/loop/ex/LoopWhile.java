...
public class LoopWhile {
	...
	*/
	...
	public static void outLoop() {		
		...
		*/	//애초에 실행이 안되는데 왜 쓰냐는 오류
	}
	
	public static void whileLoop() {
		//조건 : 조건에서 숫자가 3이상이면 조건이 거짓
	...
	public static void whileLoopEx() {
		...
		while (true) {
			...
			case 2:
				...
				//break;
				return;
				//break와 return 모두 case를 탈출하는 구문이기 때문에 같이 사용할 수 없음
				// break : while이 true일 때 종료되지 않고 계속 반복
				// return : while이 true 여도 while 코드를 탈출해서 프로그램을 종료
